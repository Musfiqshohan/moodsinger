...
import sys
sys.stdout = open('only_capa.txt', 'a')
# !pip install numpy
# !pip install xlrd
...
for num_of_nodes in [25, 50, 100, 200, 400]:
    true_graph = generate_true_causal_structure(num_of_nodes, 1.5)
    for itr in range(20):
        ...
        capa_param = run_capa(current_graph2)
        capa_graph_sep_set = copy.deepcopy(graph_sep_set)   # taking the graph sepset of capa
        graph_sep_set.clear()
        ...
        capa_param.print_stat()
        capa_param.print_test_time()
        capa_param.print_edges()
